...
ALTER TABLE logs ADD COLUMN created_time_log VARCHAR(16) NULL;
ALTER TABLE logs ADD COLUMN imported_at DATETIME NULL;
ALTER TABLE logs ADD COLUMN imported_time VARCHAR(16) NULL;
